...
class NAVI_DataLoader(Dataset):
    ...
    def __init__(
        ...
        total_track_path = os.path.join(self.features_path, "total-tracks.json")
        ...
        for video_id in total_track_keys:
            if video_id not in video_ids:
                continue
            video_dict[video_id] = total_track_path
    ...
    def _get_rawvideo(self, choice_video_ids):
        ...
        total_video_data = self.video_data
        for i, video_id in enumerate(choice_video_ids):
            ...
            raw_video_data = self.rawVideoExtractor.get_video_data(total_video_data, frame_path, video_id, max_frames)
            ...
            if len(raw_video_data.shape) > 3:
                ...
                print("video path: {} error. video id: {}. frame_path: {}".format(video_path, video_id, frame_path))
